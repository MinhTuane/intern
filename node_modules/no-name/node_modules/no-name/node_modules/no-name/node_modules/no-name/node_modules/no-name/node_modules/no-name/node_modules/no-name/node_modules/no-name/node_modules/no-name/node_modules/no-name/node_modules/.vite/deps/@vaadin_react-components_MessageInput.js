...
import { MessageInput as e } from "@vaadin/message-input/vaadin-message-input.js";
...
var _a;
window.Vaadin ?? (window.Vaadin = {}), (_a = window.Vaadin).registrations ?? (_a.registrations = []), window.Vaadin.registrations.push({ is: "@vaadin/react-components", version: "24.5.3" });
function s(e2) {
  const { elementClass: t2 } = e2;
  return createComponent("_properties" in t2 ? { ...e2, elementClass: { name: t2.name, prototype: { ...t2._properties, hidden: Boolean } } } : e2);
}

// node_modules/@vaadin/react-components/MessageInput.js
var s2 = { onSubmit: "submit" };
var o = s({ elementClass: e, events: s2, react: t, tagName: "vaadin-message-input" });
export {
  o as MessageInput,
  e as MessageInputElement
};
...
@lit/react/development/index.js:
   ...
   *)
*/
//# sourceMappingURL=@vaadin_react-components_MessageInput.js.map
