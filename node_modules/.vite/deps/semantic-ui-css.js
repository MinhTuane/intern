...
(function($, window2, document2, undefined) {
  $.site = $.fn.site = function(parameters) {
    var time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.site.settings, parameters) : $.extend({}, $.site.settings), namespace = settings.namespace, error = settings.error, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $document = $(document2), $module = $document, element = this, instance = $module.data(moduleNamespace), module, returnedValue;
    module = {
      initialize: function() {
        module.instantiate();
      },
      ...
      fix: {
        console: function() {
          ...
          if (typeof console.group == "undefined" || typeof console.groupEnd == "undefined" || typeof console.groupCollapsed == "undefined") {
            ...
            window2.console.group = function() {
            };
            window2.console.groupEnd = function() {
            };
            window2.console.groupCollapsed = function() {
            };
          }
          if (typeof console.markTimeline == "undefined") {
            module.verbose("Mark timeline not available, normalizing events");
            window2.console.markTimeline = function() {
            };
          }
        },
        ...
        requestAnimationFrame: function() {
          ...
          if (window2.requestAnimationFrame === undefined) {
            module.debug("RequestAnimationFrame not available, normalizing event");
            window2.requestAnimationFrame = window2.requestAnimationFrame || window2.mozRequestAnimationFrame || window2.webkitRequestAnimationFrame || window2.msRequestAnimationFrame || function(callback) {
      ...
      console: function(enable) {
        if (enable) {
          ...
          window2.console = instance.cache.console;
        } else {
          module.debug("Disabling console function");
          instance.cache.console = window2.console;
          window2.console = {
            clear: function() {
            },
            error: function() {
  ...
  $.fn.form = function(parameters) {
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        clear: function() {
          $field.each(function() {
            var $field2 = $(this), $element = $field2.parent(), $fieldGroup = $field2.closest($group), $prompt2 = $fieldGroup.find(selector.prompt), defaultValue = $field2.data(metadata.defaultValue) || "", isCheckbox = $element.is(selector.uiCheckbox), isDropdown = $element.is(selector.uiDropdown), isErrored = $fieldGroup.hasClass(className.error);
            if (isErrored) {
        ...
        is: {
          ...
          shorthandFields: function(fields2) {
            var fieldKeys = Object.keys(fields2), firstRule = fields2[fieldKeys[0]];
          ...
          empty: function($field2) {
            if (!$field2 || $field2.length === 0) {
              return true;
            } else if ($field2.is('input[type="checkbox"]')) {
        ...
        get: {
          ...
          fieldsFromShorthand: function(fields2) {
            var fullFields = {};
            $.each(fields2, function(name, rules) {
          ...
          prompt: function(rule, field) {
            ...
            if (requiresValue) {
              prompt = prompt.replace("{value}", $field2.val());
            }
            if (requiresName) {
          ...
          fields: function(fields2) {
            var $fields = $();
            $.each(fields2, function(index, name) {
          ...
          validation: function($field2) {
            ...
            $.each(validation, function(fieldName, field) {
              ...
              if (module.get.field(identifier)[0] == $field2[0]) {
          ...
          value: function(field) {
            var fields2 = [], results;
            fields2.push(field);
            results = module.get.values.call(element, fields2);
            return results[field];
          },
          values: function(fields2) {
            var $fields = $.isArray(fields2) ? module.get.fields(fields2) : $field, values = {};
            $fields.each(function(index, field) {
              var $field2 = $(field), type = $field2.prop("type"), name = $field2.prop("name"), value = $field2.val(), isCheckbox = $field2.is(selector.checkbox), isRadio = $field2.is(selector.radio), isMultiple = name.indexOf("[]") !== -1, isChecked = isCheckbox ? $field2.is(":checked") : false;
              if (name) {
                if (isMultiple) {
                  name = name.replace("[]", "");
                  if (!values[name]) {
        ...
        add: {
          ...
          fields: function(fields2) {
            var newValidation;
            if (fields2 && module.is.shorthandFields(fields2)) {
              newValidation = module.get.fieldsFromShorthand(fields2);
            } else {
              newValidation = fields2;
            }
            validation = $.extend({}, validation, newValidation);
          },
          prompt: function(identifier, errors) {
            ...
            if (settings.inline) {
              if (!promptExists) {
                $prompt2 = settings.templates.prompt(errors);
        ...
        remove: {
          ...
          field: function(field) {
            var fields2 = $.isArray(field) ? field : [field];
            $.each(fields2, function(index, field2) {
        ...
        set: {
          ...
          defaults: function() {
            $field.each(function() {
              var $field2 = $(this), isCheckbox = $field2.filter(selector.checkbox).length > 0, value = isCheckbox ? $field2.is(":checked") : $field2.val();
              $field2.data(metadata.defaultValue, value);
            });
          },
          error: function() {
          ...
          value: function(field, value) {
            var fields2 = {};
            fields2[field] = value;
            return module.set.values.call(element, fields2);
          },
          values: function(fields2) {
            if ($.isEmptyObject(fields2)) {
              return;
            }
            $.each(fields2, function(key, value) {
              var $field2 = module.get.field(key), $element = $field2.parent(), isMultiple = $.isArray(value), isCheckbox = $element.is(selector.uiCheckbox), isDropdown = $element.is(selector.uiDropdown), isRadio = $field2.is(selector.radio) && isCheckbox, fieldExists = $field2.length > 0, $multipleField;
              if (fieldExists) {
        ...
        validate: {
          ...
          rule: function(field, rule) {
            var $field2 = module.get.field(field.identifier), type = rule.type, value = $field2.val(), isValid = true, ancillary = module.get.ancillaryValue(rule), ruleName = module.get.ruleName(rule), ruleFunction = settings.rules[ruleName];
            if (!$.isFunction(ruleFunction)) {
              module.error(error.noRule, ruleName);
              return;
            }
            value = value === undefined || value === "" || value === null ? "" : $.trim(value + "");
            return ruleFunction.call($field2, value, ancillary);
          }
        },
        setting: function(name, value) {
          if ($.isPlainObject(name)) {
...
(function($, window2, document2, undefined) {
  ...
  $.fn.accordion = function(parameters) {
    var $allModules = $(this), time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window2.requestAnimationFrame || window2.mozRequestAnimationFrame || window2.webkitRequestAnimationFrame || window2.msRequestAnimationFrame || function(callback) {
      setTimeout(callback, 0);
    }, returnedValue;
    $allModules.each(function() {
      ...
      module = {
        ...
        open: function(query2) {
          var $activeTitle = query2 !== undefined ? typeof query2 === "number" ? $title.eq(query2) : $(query2).closest(selector.title) : $(this).closest(selector.title), $activeContent = $activeTitle.next($content), isAnimating = $activeContent.hasClass(className.animating), isActive = $activeContent.hasClass(className.active), isOpen = isActive || isAnimating;
          if (isOpen) {
        ...
        close: function(query2) {
          var $activeTitle = query2 !== undefined ? typeof query2 === "number" ? $title.eq(query2) : $(query2).closest(selector.title) : $(this).closest(selector.title), $activeContent = $activeTitle.next($content), isAnimating = $activeContent.hasClass(className.animating), isActive = $activeContent.hasClass(className.active), isOpening = !isActive && isAnimating, isClosing = isActive && isAnimating;
    ...
    $allModules.each(function() {
      ...
      module = {
        ...
        attachEvents: function(selector2, event) {
          ...
          if ($element.length > 0) {
            module.debug("Attaching checkbox events to element", selector2, event);
        ...
        trigger: {
          change: function() {
            var events = document2.createEvent("HTMLEvents"), inputElement = $input[0];
            if (inputElement) {
...
(function($, window2, document2, undefined) {
  ...
  $.fn.dimmer = function(parameters) {
    var $allModules = $(this), time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
    $allModules.each(function() {
      ...
      module = {
        ...
        addContent: function(element2) {
          var $content = $(element2);
...
(function($, window2, document2, undefined) {
  ...
  $.fn.dropdown = function(parameters) {
    var $allModules = $(this), $document = $(document2), moduleSelector = $allModules.selector || "", hasTouch = "ontouchstart" in document2.documentElement, time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
      ...
      module = {
        ...
        setup: {
          ...
          menu: function(values) {
            $menu.html(templates.menu(values, fields2));
        ...
        filter: function(query2) {
          var searchTerm = query2 !== undefined ? query2 : module.get.query(), afterFiltered = function() {
            ...
            if (settings.allowAdditions) {
              module.add.userSuggestion(query2);
            }
        ...
        queryRemote: function(query2, callback) {
          var apiSettings = {
            ...
            onSuccess: function(response) {
              var values = response[fields2.remoteValues], hasRemoteValues = $.isArray(values) && values.length > 0;
              if (hasRemoteValues) {
                module.remove.message();
                module.setup.menu({
                  values: response[fields2.remoteValues]
                });
              } else {
                module.add.message(message.noResults);
              }
        ...
        filterItems: function(query2) {
          var searchTerm = query2 !== undefined ? query2 : module.get.query(), results = null, escapedTerm = module.escape.string(searchTerm), beginsWithRegExp = new RegExp("^" + escapedTerm, "igm");
          if (module.has.query()) {
            results = [];
        ...
        determine: {
          ...
          eventOnElement: function(event, callback) {
            var $target = $(event.target), $label = $target.closest(selector.siblingLabel), inVisibleDOM = document2.body.contains(event.target), notOnLabel = $module.find($label).length === 0, notInMenu = $target.closest($menu).length === 0;
            callback = $.isFunction(callback) ? callback : function() {
            };
        ...
        add: {
          ...
          variables: function(message2, term) {
            var hasCount = message2.search("{count}") !== -1, hasMaxCount = message2.search("{maxCount}") !== -1, hasTerm = message2.search("{term}") !== -1, values, count, query2;
        ...
        animate: {
          ...
          hide: function(callback, $subMenu) {
            var $currentMenu = $subMenu || $menu, duration = $subMenu ? settings.duration * 0.9 : settings.duration, start = $subMenu ? function() {
            } : function() {
              if (module.can.click()) {
  ...
  $.fn.dropdown.settings.templates = {
    ...
    menu: function(response, fields2) {
      var values = response[fields2.values] || {}, html = "";
      $.each(values, function(index, option) {
        var maybeText = option[fields2.text] ? 'data-text="' + option[fields2.text] + '"' : "", maybeDisabled = option[fields2.disabled] ? "disabled " : "";
        html += '<div class="' + maybeDisabled + 'item" data-value="' + option[fields2.value] + '"' + maybeText + ">";
        html += option[fields2.name];
        html += "</div>";
      });
      return html;
    },
      ...
      module = {
        ...
        generate: {
          ...
          parameters: function(source, extraParameters) {
            var parameters2 = sources[source] && sources[source].parameters !== undefined ? sources[source].parameters(settings) : {};
      ...
      module = {
        ...
        storage: {
          set: function(key, value) {
            ...
            if (settings.storageMethod == "localstorage" && window2.localStorage !== undefined) {
              window2.localStorage.setItem(key, value);
              module.debug("Value stored using local storage", key, value);
            } else if (settings.storageMethod == "sessionstorage" && window2.sessionStorage !== undefined) {
              window2.sessionStorage.setItem(key, value);
          ...
          get: function(key, value) {
            var storedValue;
            if (settings.storageMethod == "localstorage" && window2.localStorage !== undefined) {
              storedValue = window2.localStorage.getItem(key);
            } else if (settings.storageMethod == "sessionstorage" && window2.sessionStorage !== undefined) {
              storedValue = window2.sessionStorage.getItem(key);
            } else if ($.cookie !== undefined) {
...
(function($, window2, document2, undefined) {
  ...
  $.fn.popup = function(parameters) {
    var $allModules = $(this), $document = $(document2), $window = $(window2), $body = $("body"), moduleSelector = $allModules.selector || "", hasTouch = true, time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
    $allModules.each(function() {
      ...
      module = {
        ...
        event: {
          ...
          hideGracefully: function(event) {
            var $target2 = $(event.target), isInDOM = $.contains(document2.documentElement, event.target), inPopup = $target2.closest(selector.popup).length > 0;
        ...
        get: {
          ...
          calculations: function() {
            var $popupOffsetParent = module.get.offsetParent($popup), targetElement = $target[0], isWindow = $boundary[0] == window2, targetPosition = settings.inline || settings.popup && settings.movePopup ? $target.position() : $target.offset(), screenPosition = isWindow ? { top: 0, left: 0 } : $boundary.offset(), calculations = {}, scroll = isWindow ? { top: $window.scrollTop(), left: $window.scrollLeft() } : { top: 0, left: 0 }, screen;
            calculations = {
          ...
          offsetParent: function($element) {
            var element2 = $element !== undefined ? $element[0] : $target[0], parentNode = element2.parentNode, $node = $(parentNode);
            if (parentNode) {
        ...
        is: {
          ...
          svg: function(element2) {
            return module.supports.svg() && element2 instanceof SVGGraphicsElement;
          },
          basic: function() {
...
(function($, window2, document2, undefined) {
  "use strict";
  window2 = typeof window2 != "undefined" && window2.Math == Math ? window2 : typeof self != "undefined" && self.Math == Math ? self : Function("return this")();
  var global = typeof window2 != "undefined" && window2.Math == Math ? window2 : typeof self != "undefined" && self.Math == Math ? self : Function("return this")();
      ...
      module = {
        ...
        bind: {
          transitionEnd: function(callback) {
            var transitionEnd2 = module.get.transitionEnd();
            $bar.one(transitionEnd2 + eventNamespace, function(event) {
              clearTimeout(module.failSafeTimer);
              callback.call(this, event);
            });
            module.failSafeTimer = setTimeout(function() {
              $bar.triggerHandler(transitionEnd2);
        ...
        get: {
          ...
          transitionEnd: function() {
            var element2 = document2.createElement("element"), transitions = {
            ...
            for (transition in transitions) {
              if (element2.style[transition] !== undefined) {
        ...
        set: {
          ...
          labelInterval: function() {
            ...
            module.interval = setInterval(function() {
              var isInDOM = $.contains(document2.documentElement, element);
              if (!isInDOM) {
                clearInterval(module.interval);
                animating = false;
              }
...
(function($, window2, document2, undefined) {
      ...
      module = {
        ...
        event: {
          ...
          result: {
            ...
            click: function(event) {
              ...
              var $result2 = $(this), $title = $result2.find(selector.title).eq(0), $link = $result2.is("a[href]") ? $result2 : $result2.find("a[href]").eq(0), href = $link.attr("href") || false, target = $link.attr("target") || false, title = $title.html(), value = $title.length > 0 ? $title.text() : false, results = module.get.results(), result = $result2.data(metadata.result) || module.get.result(value, results), returnedValue2;
        ...
        get: {
          ...
          result: function(value, results) {
            var lookupFields = ["title", "id"], result = false;
        ...
        search: {
          ...
          object: function(searchTerm, source, searchFields) {
            var results = [], exactResults = [], fuzzyResults = [], searchExp = searchTerm.toString().replace(regExp.escape, "\\$&"), matchRegExp = new RegExp(regExp.beginsWith + searchExp, "i"), addResult = function(array, result) {
        ...
        parse: {
          response: function(response, searchTerm) {
            ...
            if (response !== undefined) {
              if (searchTerm !== undefined && response[fields2.results] !== undefined) {
                module.addResults(searchHTML);
                module.inject.id(response[fields2.results]);
                module.write.cache(searchTerm, {
                  html: searchHTML,
                  results: response[fields2.results]
                });
                module.save.results(response[fields2.results]);
              }
            }
          }
        },
        ...
        inject: {
          ...
          id: function(results) {
            ...
            if (settings.type === "category") {
              $.each(results, function(index, category) {
                resultIndex = 0;
                $.each(category.results, function(index2, value) {
                  var result = category.results[index2];
        ...
        generateResults: function(response) {
          ...
          var template = settings.templates[settings.type], isProperObject = $.isPlainObject(response[fields2.results]) && !$.isEmptyObject(response[fields2.results]), isProperArray = $.isArray(response[fields2.results]) && response[fields2.results].length > 0, html = "";
          if (isProperObject || isProperArray) {
            if (settings.maxResults > 0) {
              if (isProperObject) {
                ...
                response[fields2.results] = response[fields2.results].slice(0, settings.maxResults);
              }
            }
            if ($.isFunction(template)) {
              html = template(response, fields2);
            } else {
  ...
  $.fn.search.settings = {
    ...
    templates: {
      ...
      category: function(response, fields2) {
        var html = "", escape = $.fn.search.settings.templates.escape;
        if (response[fields2.categoryResults] !== undefined) {
          $.each(response[fields2.categoryResults], function(index, category) {
            if (category[fields2.results] !== undefined && category.results.length > 0) {
              html += '<div class="category">';
              if (category[fields2.categoryName] !== undefined) {
                html += '<div class="name">' + category[fields2.categoryName] + "</div>";
              }
              html += '<div class="results">';
              $.each(category.results, function(index2, result) {
                if (result[fields2.url]) {
                  html += '<a class="result" href="' + result[fields2.url] + '">';
                } else {
                  html += '<a class="result">';
                }
                if (result[fields2.image] !== undefined) {
                  html += '<div class="image"> <img src="' + result[fields2.image] + '"></div>';
                }
                html += '<div class="content">';
                if (result[fields2.price] !== undefined) {
                  html += '<div class="price">' + result[fields2.price] + "</div>";
                }
                if (result[fields2.title] !== undefined) {
                  html += '<div class="title">' + result[fields2.title] + "</div>";
                }
                if (result[fields2.description] !== undefined) {
                  html += '<div class="description">' + result[fields2.description] + "</div>";
                }
                html += "</div>";
                html += "</a>";
              });
          ...
          if (response[fields2.action]) {
            html += '<a href="' + response[fields2.action][fields2.actionURL] + '" class="action">' + response[fields2.action][fields2.actionText] + "</a>";
          }
          return html;
        }
        return false;
      },
      standard: function(response, fields2) {
        var html = "";
        if (response[fields2.results] !== undefined) {
          $.each(response[fields2.results], function(index, result) {
            if (result[fields2.url]) {
              html += '<a class="result" href="' + result[fields2.url] + '">';
            } else {
              html += '<a class="result">';
...
(function($, window2, document2, undefined) {
  ...
  $.fn.shape = function(parameters) {
    var $allModules = $(this), $body = $("body"), time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window2.requestAnimationFrame || window2.mozRequestAnimationFrame || window2.webkitRequestAnimationFrame || window2.msRequestAnimationFrame || function(callback) {
      setTimeout(callback, 0);
    }, returnedValue;
    $allModules.each(function() {
      var moduleSelector = $allModules.selector || "", settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.shape.settings, parameters) : $.extend({}, $.fn.shape.settings), namespace = settings.namespace, selector = settings.selector, error = settings.error, className = settings.className, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $module = $(this), $sides = $module.find(selector.sides), $side = $module.find(selector.side), nextIndex = false, $activeSide, $nextSide, element = this, instance = $module.data(moduleNamespace), module;
      module = {
        initialize: function() {
        ...
        set: {
          ...
          currentStageSize: function() {
            var $activeSide2 = $module.find("." + settings.className.active), width = $activeSide2.outerWidth(true), height = $activeSide2.outerHeight(true);
            $module.css({
              width,
              height
            });
          ...
          stageSize: function() {
            var $clone = $module.clone().addClass(className.loading), $activeSide2 = $clone.find("." + settings.className.active), $nextSide2 = nextIndex ? $clone.find(selector.side).eq(nextIndex) : $activeSide2.next(selector.side).length > 0 ? $activeSide2.next(selector.side) : $clone.find(selector.side).first(), newWidth = settings.width == "next" ? $nextSide2.outerWidth(true) : settings.width == "initial" ? $module.width() : settings.width, newHeight = settings.height == "next" ? $nextSide2.outerHeight(true) : settings.height == "initial" ? $module.height() : settings.height;
...
(function($, window2, document2, undefined) {
  ...
  $.fn.sidebar = function(parameters) {
    var $allModules = $(this), $window = $(window2), $document = $(document2), $html = $("html"), $head = $("head"), moduleSelector = $allModules.selector || "", time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window2.requestAnimationFrame || window2.mozRequestAnimationFrame || window2.webkitRequestAnimationFrame || window2.msRequestAnimationFrame || function(callback) {
      setTimeout(callback, 0);
    }, returnedValue;
    $allModules.each(function() {
      ...
      module = {
        ...
        attachEvents: function(selector2, event) {
          ...
          event = $.isFunction(module[event]) ? module[event] : module.toggle;
          if ($toggle.length > 0) {
            module.debug("Attaching sidebar events to element", selector2, event);
        ...
        scrollToTop: function() {
          ...
          currentScroll = $(window2).scrollTop();
          $module.scrollTop(0);
          window2.scrollTo(0, 0);
        },
        scrollBack: function() {
          module.verbose("Scrolling back to original page position");
          window2.scrollTo(0, currentScroll);
        },
        clear: {
          cache: function() {
...
(function($, window2, document2, undefined) {
  ...
  $.fn.sticky = function(parameters) {
    var $allModules = $(this), moduleSelector = $allModules.selector || "", time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue;
    $allModules.each(function() {
      var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.sticky.settings, parameters) : $.extend({}, $.fn.sticky.settings), className = settings.className, namespace = settings.namespace, error = settings.error, eventNamespace = "." + namespace, moduleNamespace = "module-" + namespace, $module = $(this), $window = $(window2), $scroll = $(settings.scrollContext), $container, $context, selector = $module.selector || "", instance = $module.data(moduleNamespace), requestAnimationFrame = window2.requestAnimationFrame || window2.mozRequestAnimationFrame || window2.webkitRequestAnimationFrame || window2.msRequestAnimationFrame || function(callback) {
        setTimeout(callback, 0);
      ...
      module = {
        ...
        supports: {
          sticky: function() {
            var $element = $("<div/>"), element2 = $element[0];
        ...
        save: {
          ...
          positions: function() {
            ...
            if (!module.is.standardScroll()) {
              ...
              element2.offset.top += scrollContext.top;
              context.offset.top += scrollContext.top;
              element2.offset.left += scrollContext.left;
              context.offset.left += scrollContext.left;
            }
            module.cache = {
              fits: element2.height + settings.offset <= scrollContext.height,
              sameHeight: element2.height == context.height,
              scrollContext: {
                height: scrollContext.height
              },
              element: {
                margin: element2.margin,
                top: element2.offset.top - element2.margin.top,
                left: element2.offset.left,
                width: element2.width,
                height: element2.height,
                bottom: element2.offset.top + element2.height
              },
              context: {
        ...
        get: {
          ...
          elementScroll: function(scroll) {
            scroll = scroll || $scroll.scrollTop();
            var element2 = module.cache.element, scrollContext = module.cache.scrollContext, delta = module.get.scrollChange(scroll), maxScroll = element2.height - scrollContext.height + settings.offset, elementScroll = module.get.currentElementScroll(), possibleScroll = elementScroll + delta;
        ...
        set: {
          ...
          minimumSize: function() {
            var element2 = module.cache.element;
            $container.css("min-height", element2.height);
          },
        ...
        stick: function(scroll) {
          var cachedPosition = scroll || $scroll.scrollTop(), cache = module.cache, fits = cache.fits, sameHeight = cache.sameHeight, element2 = cache.element, scrollContext = cache.scrollContext, context = cache.context, offset = module.is.bottom() && settings.pushing ? settings.bottomOffset : settings.offset, scroll = {
            top: cachedPosition + offset,
            bottom: cachedPosition + offset + scrollContext.height
          }, direction = module.get.direction(scroll.top), elementScroll = fits ? 0 : module.get.elementScroll(scroll.top), doesntFit = !fits, elementVisible = element2.height !== 0;
          if (elementVisible && !sameHeight) {
            if (module.is.initialPosition()) {
              if (scroll.top >= context.bottom) {
                module.debug("Initial element position is bottom of container");
                module.bindBottom();
              } else if (scroll.top > element2.top) {
                if (element2.height + scroll.top - elementScroll >= context.bottom && element2.height < context.height) {
                  module.debug("Initial element position is bottom of container");
                  module.bindBottom();
                } else {
              ...
              if (module.is.top()) {
                if (scroll.top <= element2.top) {
                  module.debug("Fixed element reached top of container");
                  module.setInitialPosition();
                } else if (element2.height + scroll.top - elementScroll >= context.bottom) {
                ...
                if (scroll.bottom - element2.height <= element2.top) {
              ...
              if (scroll.top <= element2.top) {
                ...
                if (settings.pushing) {
                  ...
                  if (module.is.bound() && scroll.top <= context.bottom - element2.height) {
...
(function($, window2, document2, undefined) {
  ...
  $.fn.transition = function() {
    var $allModules = $(this), moduleSelector = $allModules.selector || "", time = (/* @__PURE__ */ new Date()).getTime(), performance = [], moduleArguments = arguments, query = moduleArguments[0], queryArguments = [].slice.call(arguments, 1), methodInvoked = typeof query === "string", requestAnimationFrame = window2.requestAnimationFrame || window2.mozRequestAnimationFrame || window2.webkitRequestAnimationFrame || window2.msRequestAnimationFrame || function(callback) {
      setTimeout(callback, 0);
    }, returnedValue;
    $allModules.each(function(index) {
      var $module = $(this), element = this, settings, instance, error, className, metadata, animationEnd, animationName, namespace, moduleNamespace, eventNamespace, module;
      module = {
        initialize: function() {
        ...
        set: {
          ...
          duration: function(animationName2, duration) {
            duration = duration || settings.duration;
            duration = typeof duration == "number" ? duration + "ms" : duration;
        ...
        get: {
          ...
          animationStartEvent: function() {
            var element2 = document2.createElement("div"), animations = {
            ...
            for (animation in animations) {
              if (element2.style[animation] !== undefined) {
...
(function($, window2, document2, undefined) {
  "use strict";
  var window2 = typeof window2 != "undefined" && window2.Math == Math ? window2 : typeof self != "undefined" && self.Math == Math ? self : Function("return this")();
        ...
        event: {
          ...
          xhr: {
            always: function() {
              ...
              var context2 = this, elapsedTime = (/* @__PURE__ */ new Date()).getTime() - requestStartTime, timeLeft = settings.loadingDuration - elapsedTime, translatedResponse = $.isFunction(settings.onResponse) ? module.is.expectingJSON() ? settings.onResponse.call(context2, $.extend(true, {}, response)) : settings.onResponse.call(context2, response) : false;
...
(function($, window2, document2, undefined) {
  ...
  $.fn.visibility = function(parameters) {
    var $allModules = $(this), moduleSelector = $allModules.selector || "", time = (/* @__PURE__ */ new Date()).getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == "string", queryArguments = [].slice.call(arguments, 1), returnedValue, moduleCount = $allModules.length, loadedCount = 0;
    $allModules.each(function() {
      ...
      module = {
        ...
        save: {
          ...
          elementPosition: function() {
            var element2 = module.cache.element, screen = module.get.screenSize();
            module.verbose("Saving element position");
            element2.fits = element2.height < screen.height;
            element2.offset = $module.offset();
            element2.width = $module.outerWidth();
            element2.height = $module.outerHeight();
            if (module.is.verticallyScrollableContext()) {
              element2.offset.top += $context.scrollTop() - $context.offset().top;
            }
            if (module.is.horizontallyScrollableContext()) {
              element2.offset.left += $context.scrollLeft - $context.offset().left;
            }
            module.cache.element = element2;
            return element2;
          },
          elementCalculations: function() {
            var screen = module.get.screenCalculations(), element2 = module.get.elementPosition();
            if (settings.includeMargin) {
              element2.margin = {};
              element2.margin.top = parseInt($module.css("margin-top"), 10);
              element2.margin.bottom = parseInt($module.css("margin-bottom"), 10);
              element2.top = element2.offset.top - element2.margin.top;
              element2.bottom = element2.offset.top + element2.height + element2.margin.bottom;
            } else {
              element2.top = element2.offset.top;
              element2.bottom = element2.offset.top + element2.height;
            }
            element2.topPassed = screen.top >= element2.top;
            element2.bottomPassed = screen.top >= element2.bottom;
            element2.topVisible = screen.bottom >= element2.top && !element2.topPassed;
            element2.bottomVisible = screen.bottom >= element2.bottom && !element2.bottomPassed;
            element2.pixelsPassed = 0;
            element2.percentagePassed = 0;
            element2.onScreen = (element2.topVisible || element2.passing) && !element2.bottomPassed;
            element2.passing = element2.topPassed && !element2.bottomPassed;
            element2.offScreen = !element2.onScreen;
            if (element2.passing) {
              element2.pixelsPassed = screen.top - element2.top;
              element2.percentagePassed = (screen.top - element2.top) / element2.height;
            }
            module.cache.element = element2;
            module.verbose("Updated element calculations", element2);
            return element2;
          },
        ...
        get: {
          pixelsPassed: function(amount) {
            var element2 = module.get.elementCalculations();
            if (amount.search("%") > -1) {
              return element2.height * (parseInt(amount, 10) / 100);
            }
...
semantic-ui-css/semantic.js:
   ...
   *)
*/
//# sourceMappingURL=semantic-ui-css.js.map
